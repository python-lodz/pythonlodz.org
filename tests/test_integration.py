...
class TestGoogleSheetsIntegration:
    ...
    def complete_mock_data(self):
        ...
        meetups_data = [
            ...
            [
                "58", "Meetup #58", "2025-05-28", "18:00", 
                "IndieBI, Piotrkowska 157A, budynek Hi Piotrkowska", "TRUE",
                "https://www.meetup.com/python-lodz/events/306971418/",
                "https://forms.gle/237YJFHy6G1jw9999", "b1rlgmlVHQo",
                "indiebi,sunscrapers", "Następne spotkanie!", "TRUE"
            ],
            [
                "59", "Meetup #59", "2025-07-30", "18:00",
                "IndieBI, Piotrkowska 157A, budynek Hi Piotrkowska", "TRUE",
                "https://www.meetup.com/python-lodz/events/306971418/", "", "",
                "indiebi,sunscrapers", "Następne spotkanie!", "TRUE"
            ],
            [
                "60", "Meetup #60", "2025-09-30", "18:00",
                "TBA", "FALSE", "", "", "", "", "", "FALSE"
            ]
        ]
        ...
        talks_data = [
            [
                ...
                "Opis prezentacji", "Tytuł prezentacji EN", "Język prezentacji", 
                "Link do LinkedIn", "Link do GitHub", "Link do Twitter", "Link do strony"
            ],
            [
                "58", "Grzegorz", "Kocjan", 
                ...
                "pl",
                "https://linkedin.com/in/grzegorzkocjan", "https://github.com/gkocjan", "", ""
            ],
            [
                "58", "Sebastian", "Buczyński",
                ...
                "pl",
                "https://linkedin.com/in/sebastianbuczynski", "", "https://twitter.com/sebabuczynski", ""
            ],
            [
                "59", "Łukasz", "Langa",
                ...
                "pl",
                "https://linkedin.com/in/lukaszlanga", "https://github.com/ambv", "", "https://lukasz.langa.pl"
            ]
        ]
    ...
    def test_complete_data_flow_single_meetup(self, mock_fetch_talks, mock_fetch_meetups,
                                              repository, complete_mock_data):
        ...
        assert talk1.title == "Pythonowa konfiguracja, która przyprawi Cię o dreszcze (w dobry sposób, obiecuję!)"
        assert talk1.title_en == "Python Config That Will Give You Chills (In a Good Way, I Promise!)"
        ...
        assert talk2.title == "Programista zoptymalizował aplikację, ale nikt mu nie pogratulował bo była w Pythonie 😔"
    ...
    @patch('pyldz.repository.GoogleSheetsRepository.fetch_meetups_data')
    @patch('pyldz.repository.GoogleSheetsRepository.fetch_talks_data')
    def test_complete_data_flow_all_enabled_meetups(self, mock_fetch_talks, mock_fetch_meetups,
                                                    repository, complete_mock_data):
    ...
    @patch('pyldz.repository.GoogleSheetsRepository.fetch_meetups_data')
    @patch('pyldz.repository.GoogleSheetsRepository.fetch_talks_data')
    def test_speakers_extraction_and_deduplication(self, mock_fetch_talks, mock_fetch_meetups,
                                                   repository, complete_mock_data):
    ...
    @patch('pyldz.repository.GoogleSheetsRepository.fetch_meetups_data')
    @patch('pyldz.repository.GoogleSheetsRepository.fetch_talks_data')
    def test_disabled_meetup_filtering(self, mock_fetch_talks, mock_fetch_meetups,
                                       repository, complete_mock_data):
    ...
    def test_error_handling_and_resilience(self, mock_get_creds, mock_build, repository):
    ...
    def test_model_integration_and_validation(self):
        ...
        from pyldz.models import TalkSheetRow, MeetupSheetRow
